...
echo ">> 1) Patch da linha 'Colaborador:' (remove sufixo antigo e aplica labelTitle)"
for f in "${FILES[@]}"; do
...
if not pat.search(src):
    ...
    # usar lambda para evitar que o Python interprete backslashes do replacement
...
# 3) Testes: imprime só a 2a linha (Colaborador: …)
...
echo
echo ">> FIM: copie aqui as 3 linhas 'Colaborador:' impressas acima."
